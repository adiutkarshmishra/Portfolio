  ...
  return (
    <div className="flex items-center gap-2">
      <div className="flex gap-0.5 rounded-full">
        <div className="border-border flex items-center gap-1.5 rounded-l-full border bg-secondary p-3">
        ...
        {showSettings && (
          <button
            ...
            className="flex items-center justify-center rounded-r-full border border-l-0 border-border bg-secondary px-3 transition"
          >
